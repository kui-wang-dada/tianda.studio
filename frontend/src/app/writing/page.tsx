...
export const metadata: Metadata = { title: 'Writing · 文章' }
...
export default function WritingIndexPage() {
  ...
  return (
    <section className="py-16">
      <Container>
        <div className="mb-8">
          <div className="eyebrow">— Writing · 文章 —</div>
          <h1 className="mt-2 text-3xl font-bold tracking-tight md:text-4xl">最近笔记</h1>
          <p className="mt-2 text-sm text-muted">{items.length} 篇 · 技术随笔、踩坑日记、产品复盘</p>
        </div>
            ...
            <li key={item.slug} className="border-b border-line last:border-b-0">
              ...
              >
                ...
                <div className="text-right font-mono text-[11px] tracking-wider text-muted2">
                  ...
                  {item.reading_time && <div className="mt-1 text-brand">{item.reading_time} min →</div>}
                </div>
              </Link>
            </li>
          ))}
